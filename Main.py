...
kichy = Label(App, text='8:00')
kichy.grid(row=1, column=1)
kichy2 = Label(App, text='8:30')
kichy2.grid(row=2, column=1)
kichy3 = Label(App, text='9:00')
kichy3.grid(row=3, column=1)
kichy4 = Label(App, text='9:30')
kichy4.grid(row=4, column=1)
kichy5 = Label(App, text='10:00')
kichy5.grid(row=5, column=1)
kichy6 = Label(App, text='10:30')
kichy6.grid(row=6, column=1)
kichy7 = Label(App, text='11:00')
kichy7.grid(row=7, column=1)
kichy8 = Label(App, text='11:30')
kichy8.grid(row=8, column=1)
kichy9 = Label(App, text='12:00')
kichy9.grid(row=9, column=1)
kichy10 = Label(App, text='12:30')
kichy10.grid(row=10, column=1)
kichy11 = Label(App, text='1:00')
kichy11.grid(row=11, column=1)
kichy12 = Label(App, text='1:30')
kichy12.grid(row=12, column=1)
kichy13 = Label(App, text='2:00')
kichy13.grid(row=13, column=1)
kichy14 = Label(App, text='2:30')
kichy14.grid(row=14, column=1)
kichy15 = Label(App, text='2:30')
kichy15.grid(row=15, column=1)
kichy16 = Label(App, text='3:00')
kichy16.grid(row=16, column=1)
kichy17 = Label(App, text='3:30')
kichy17.grid(row=17, column=1)
kichy18 = Label(App, text='4:00')
kichy18.grid(row=18, column=1)
kichy19 = Label(App, text='4:30')
kichy19.grid(row=19, column=1)
kichy20 = Label(App, text='5:00')
